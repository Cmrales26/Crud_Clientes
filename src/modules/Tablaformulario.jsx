...
const Tabla = () => {
  ...
  const estadoInicial = [
    { id: 1, nombre: 'Nelson', apellido: 'Morales', edad: 21 },
    { id: 2, nombre: 'Diana', apellido: 'Vidal', edad: 20 },
    { id: 3, nombre: 'Sharith', apellido: 'Blanco', edad: 27 },
    { id: 4, nombre: 'Andrea', apellido: 'Valderrama', edad: 17 }
  ]
  ...
  const editar = () => {
    ...
    NuevosDatos.map(usuario => {
      if (usuario.id === UsuarioSelecionado.id) {
        if (UsuarioSelecionado.nombre.trim() != "" && UsuarioSelecionado.apellido.trim() != "" && UsuarioSelecionado.edad != "") {
